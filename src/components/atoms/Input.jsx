...
const Input = forwardRef(({ 
  ...
  const baseClasses = 'w-full px-4 py-3 text-base border-2 rounded-lg transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-offset-1 disabled:opacity-50 disabled:cursor-not-allowed';
  ...
  const filterProps = ({ 
    label, error, icon, iconPosition, containerClassName, ...rest 
  }) => rest;
